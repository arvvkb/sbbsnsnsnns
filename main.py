...
bot = telebot.TeleBot('7465596386:AAGSemkG86o-RihMnd9ke8UbfsRDOxGFZbU', parse_mode='HTML')
group='bdbdndhe'
...
@bot.message_handler(func=lambda message: message.text.lower().startswith(('.chk', '/chk')) or message.text.lower().startswith(('.pp', '/pp')))
def respond_to_vbv(message):
...
print(chk('4082646830933209|09|2032|904'))
while True:
	try:
